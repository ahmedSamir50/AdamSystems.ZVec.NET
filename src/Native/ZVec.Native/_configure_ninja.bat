...
"%CMAKE%" -S "%ROOT%" -B "%ROOT%\build" -G Ninja -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_COMPILER=cl -DCMAKE_CXX_COMPILER=cl "-DSNOWBALL_HOST_CC=%GCC:\=/%" -DOVERRIDE_GIT_DESCRIBE=v0.7.0
if errorlevel 1 exit /b 1
