...
> **Beta** — `1.0.0-beta.4+zvec.0.6.0`. APIs may still evolve. PackageId **`ZVec.NET`** on nuget.org (distinct from the unrelated NuGet package [`Zvec`](https://www.nuget.org/packages/Zvec)).
